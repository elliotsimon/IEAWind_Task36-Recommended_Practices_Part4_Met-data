...
\input{sections/02_instrumentation.tex}
\input{sections/03_measurements.tex}
\input{sections/04_power_measurements}
\input{sections/05_performance_assessment.tex}
\input{sections/06_best_practice.tex}
